...
_VOICES: list[str] = [
    ...
    "gen.chaos.lorenz_attractor",
    "gen.chaos.rossler_chaos",
    "gen.chaos.logistic_map",
    "gen.chaos.chua_circuit",
    "gen.synth.tb303_acid_bass",
    "gen.synth.minimoog_sub",
    "gen.synth.oberheim_sem_pad",
    "gen.synth.ms20_ring_mod",
    "gen.fm.six_operator_pad",
    "gen.fm.six_operator_bell",
    "gen.fm.six_operator_drone",
    "gen.additive.partials_32",
    "gen.additive.drawbar_bank",
    "gen.additive.spectral_tilt",
    "gen.physical.steel_pan",
    "gen.physical.tubular_bell",
    "gen.physical.glass_harmonica",
    "gen.physical.water_drop",
    "gen.texture.reverse_grain",
    "gen.texture.pitch_shift_grain",
    "gen.texture.softcut_tape",
    "gen.vocal.soprano_formant",
    "gen.vocal.tenor_formant",
    "gen.vocal.whispering_rain",
    "gen.synth.casio_cz_pd",
    "gen.synth.vector_3d_pad",
    "gen.synth.chebyshev_bank",
    "gen.arpeggio.subharmonic_seq",
]
